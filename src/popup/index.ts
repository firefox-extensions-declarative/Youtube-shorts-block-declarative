...
window.onload = async () => {
    ...
    (document.getElementById("hideShortTabInput") as HTMLInputElement).checked =
        config.hideTabs;
    (
        document.getElementById("hideShortVideoInput") as HTMLInputElement
    ...
    (document.getElementById("warn_fb") as HTMLAnchorElement).href =
        feedbackURL;
...
function setToggleAttribute(isOpen: boolean) {
    ...
    document
        .getElementById("toggle_wrap")
        ?.setAttribute("checked", isOpen.toString());
    document
        .getElementById("toggle_circle")
        ?.setAttribute("checked", isOpen.toString());
}
